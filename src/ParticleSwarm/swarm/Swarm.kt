package ParticleSwarm.swarm

import ParticleSwarm.mConst.Constants
import ParticleSwarm.particle.Particle
import java.util.*
...
data class Swarm(var numParticles: Int) {
    ...
    init {
        for (i in 0 until numParticles) {
            ...
            particles[i] =
                Particle(initialParticlePosition, initialParticleSpeed)
        }
    }
}