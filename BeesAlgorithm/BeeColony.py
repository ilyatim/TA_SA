...
plt.figure("BeeSwarm")
beeSwarm = BeeSwarm()
value = beeSwarm.start(400, 450, 400, 26, 50)
print(value[1])
print(intfy(value[0]))
plot_actions(intfy(value[0]), beeSwarm.environment)
print(beeSwarm.environment.count_loss_for_path(intfy(value[0]), verbose=True))
plt.show()
